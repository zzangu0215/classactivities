...
// describe blocks describe the area being tested
describe("<Welcome />", () => {
  // it describes an individual assertion or set of assertions (a single test)
  ...
  it("renders with name and topic props", () => {
