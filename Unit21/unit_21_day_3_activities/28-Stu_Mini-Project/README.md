...
In this mini-project, you are going to finish a MERN-stack application that allows users to create a matchup between two technologies and vote on their favorite technology.  You will need to update the server and client implementing code for a GraphQL API built with Apollo Server and Apollo Client.
