...
function initLazyImages() {
  ...
  //
  // Refer to activity 04.5-Lazy-Images for an example of how to use the
  // Intersection Observer API to lazy-load images. Be sure to use ".lazy-image"
  // to select the img elements. Each img element should have a "data-src"
  // attribute which holds the path for the image that should be loaded.
  // ...
  // -------------------------------------------
...
function createCard(image) {
  ...
  // -------------------------------------------
  // TODO: ADD and MODIFY code here to update img elements so that they are
  // setup for lazy loading.

  // Set the initial src attribute to a placeholder. (See hint in the
  // instructions.)

  // Add "lazy-image" class to the img element.

  // Add "data-src" attribute with the path to the image that should load when
  // the image is scrolled into view.
