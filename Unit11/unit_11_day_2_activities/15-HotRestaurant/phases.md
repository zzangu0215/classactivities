...
- This phase is for planning your approach and figuring out the various smaller
  problems to tackle. You won't be writing any code during this phase. Figure
  out any functions/objects you will need to create. Define the input/output for
  any functions and the properties/types for any objects.
