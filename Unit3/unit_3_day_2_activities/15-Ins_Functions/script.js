...
// Functions must be called to execute (i.e. run the code within the function's
// braces)
declareHello(); // This will run lines 4-7. Then, execution returns back to this line.
expressHello(); // This will run lines 12-14. Then execution returns back to this line.
