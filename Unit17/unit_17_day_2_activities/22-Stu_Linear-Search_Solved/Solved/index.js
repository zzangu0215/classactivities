...
// This implementation will identify the first index that holds our searched
// element and return that index:
const linearSearch = (array, element) => {
  // Loop the given array.
  for (let index = 0; index < array.length; index += 1) {
    // Check to see if the index of the given array is equal to the element we
    // are searching for.
...
// A different implementation of this function that will return an array of
// every index the searched element appears:
const linearSearchMultipleElements = (array, element) => {
  ...
  for (let index = 0; index < array.length; index += 1) {
    ...
    // are searching for.
    if (array[index] === element) {
      // Pushes the index of the element we are searching for to the array we
      // created.
      elemIndexes.push(index);
    }
  }

  // Before returning the array of indexes, we first need to check if we have
  // collected any.
