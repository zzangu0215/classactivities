...
function bankAccount() {
  ...
  return {
    displayFunds() {
      ...
      // This is a closure. The inner function has access to the outer functions
      // scope.
      console.log(
...
// With our newly created variable call the `displayFunds` method attached to
// it.
myBank.displayFunds();

// Check the console and expand the given object -> displayFunds -> Scope and
// then you should be able to visually see your closures.
console.dir(myBank);

// By console logging the outer function's variable we can see that the
// variables are not able to be accessed.
